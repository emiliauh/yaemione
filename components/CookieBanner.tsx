  ...
  return (
    <div className="fixed bottom-4 inset-x-0 z-50">
      <div className="container-app">
        <div className="card p-4 flex flex-col md:flex-row md:items-center gap-3 md:gap-6 md:justify-between">
          <p className="text-sm text-gray-200">We use cookies to personalize content and analyze traffic. By using this site, you agree to our cookie policy.</p>
