...
export default function Hero() {
  return (
    <section className="section pt-28 relative">
      <AnimatedBackdrop />
      ...
      <div className="container-app relative z-10">
        ...
        >
          ...
          <div className="px-6 py-12 md:px-12 md:py-16 lg:px-16 text-center">
            ...
            <h1 className="mt-3 text-4xl md:text-6xl font-extrabold tracking-tight leading-tight text-slate-900 dark:text-white">
